        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form method="POST" action="{{ route('farm_record.update', $getRecord->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label>Activity Title<span style="color: red">*</span> </label>
                            <input type="text" class="form-control" name="activity_title" required placeholder="Activity Title" value="{{ old('activity_title', $getRecord->activity_title) }}">
                            <div style="color: red;">{{ $errors->first('activity_title') }}</div>
                        </div>

                        <div class="form-group col-md-6">
                            <label>Activity Type</label>
                            <input type="text" class="form-control" name="activity_type" placeholder="Activity Type" value="{{ old('activity_type', $getRecord->activity_type) }}">
                        ...
                        <div class="form-group col-md-2">
                            @if (!empty($getRecord->picture))
                                <a href="{{ asset('upload/farm_records/' . $getRecord->picture) }}" target="_blank">
                                    <img 
                                        src="{{ asset('upload/farm_records/' . $getRecord->picture) }}" 
                                        alt="Picture" 
