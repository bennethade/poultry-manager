...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-8">
                <h4> Expense Made: <span style="color: brown">{{ $getRecord->category }}</span></h4>
            </div>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6" style="margin-top: 20px; border-top: 1px solid #ccc; padding-top: 20px;">
