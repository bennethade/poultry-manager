    ...
    @foreach ($getRecord as $value)
        <tr>
            ...
            <td style="min-width: 200px;">
                <a href="{{ route('expenses.view', [$value->id]) }}" class="btn btn-warning btn-sm">View</a>
                
                <a href="{{ route('expenses.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                <form action="{{ url('admin/expense_record/daily_expense/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                    @csrf
                    @method('DELETE')
