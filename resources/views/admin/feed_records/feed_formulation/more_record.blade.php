...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h5>More Record for: <span style="color: brown">{{ $getFeedFormulation->feed_stage }}</span></h5>
        </div>
        <div class="col-sm-6" style="text-align: right;">
            <h5>Initial Quantity: <span style="color: brown">{{ $getFeedFormulation->quantity }}</span>(KG)</h5>
        </div>
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card">
        <form action="{{ route('feed_formulation.more_record.store', $getFeedFormulation->id) }}" method="POST" class="breeding-form">
            @csrf
                ...
                <div id="breedFormBody" style="display:none;">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="number" name="quantity_used" placeholder="Today's usage (KG)" step="any">
                        </div>

                        <div class="form-group col-md-4">
                            <label>Quantity Remaining (KG)</label>
                            <input class="form-control" type="number" name="quantity_remaining" placeholder="Total remaining (KG)" step="any">
                        </div>
                ...
                <tbody>
                    ...
                    @foreach ($getRecord as $value)
                        <tr>
                            ...
                            <td style="min-width: 100px;">{{ $value->quantity_used }}</td>
                            <td style="min-width: 100px;">{{ $value->quantity_remaining }}</td>
                            ...
                            <td style="min-width: 150px;">
                                ...
                                <a href="{{ route('feed_formulation.more_record.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                                <form action="{{ url('admin/feed_record/feed_formulation/more_record/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
