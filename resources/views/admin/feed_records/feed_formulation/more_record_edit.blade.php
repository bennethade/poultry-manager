                ...
                <div id="breedFormBody" style="">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="number" name="quantity_used" placeholder="Today's usage" value="{{ old('quantity_used', $getRecord->quantity_used) }}" step="any">
                        </div>

                        <div class="form-group col-md-4">
                            <label>Quantity Remaining</label>
                            <input class="form-control" type="number" name="quantity_remaining" placeholder="Total remaining" value="{{ old('quantity_remaining', $getRecord->quantity_remaining) }}" step="any">
                        </div>
