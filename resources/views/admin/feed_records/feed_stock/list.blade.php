    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6" style="text-align: right;">
          <a href="{{ route('feed_stock.add') }}" class="btn btn-primary">Add New Record</a>
            ...
            <div class="card-body p-0" style="overflow: auto;">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  @include('admin.feed_records.feed_stock.partials.record_rows')
    ...
    <script>
      ...
      $(document).ready(function () {
          $('input[name="name"]').on('keyup', debounce(function () {
              ...
              $.ajax({
                  url: "{{ route('feed_stock.ajax.search') }}",
                  type: "GET",
                  data: { name: query },
