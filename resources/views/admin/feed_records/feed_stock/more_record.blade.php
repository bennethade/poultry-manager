...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h5>More Record for: <span style="color: brown">{{ $getFeedStock->feed_type }}</span></h5>
        </div>
        <div class="col-sm-6" style="text-align: right;">
            <h5>Initial Quantity: <span style="color: brown">{{ $getFeedStock->quantity_received }}</span>(KG)</h5>
        </div>
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card">
        <form action="{{ route('feed_stock.more_record.store', $getFeedStock->id) }}" method="POST" class="breeding-form">
            @csrf
                    ...
                    @foreach ($getRecord as $value)
                        <tr>
                            ...
                            <td style="min-width: 150px;">
                                ...
                                <a href="{{ route('feed_stock.more_record.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                                <form action="{{ url('admin/feed_record/feed_stock/more_record/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
