...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card">
        <form action="{{ route('breeding_record.more_record.store', $getBreedRecord->id) }}" method="POST" class="breeding-form">
            @csrf
                    ...
                    @foreach ($getRecord as $value)
                        <tr>
                            ...
                            <td style="min-width: 150px;">
                                ...
                                <a href="{{ route('breeding_record.more_record.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                                <form action="{{ url('admin/animal_record/breeding_record/more_record/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
