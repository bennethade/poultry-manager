...
<div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-12">
               <h1>HUNDRED COMMENTS BY BENJAS TECH</h1>
            </div>
         </div>
      </div>
   </section>
         ...
         <div class="row">
            <div class="col-md-12">
               <div class="card card-primary" style="padding: 20px;">
                ...
                <h2>Character Traits (Needs Improvement)</h2>
                ...
                ________ consistently needs reminders to use time effectively.<br/><br>
                ...
                <h2><strong>MORE GENERAL COMMENTS</strong></h2>
