...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card">
        <form action="{{ route('medication_treatment.more_record.store', $getMedicationTreatment->id) }}" method="POST" class="breeding-form">
            @csrf
                ...
                <div id="breedFormBody" style="display:none;">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="text" name="drug_info" placeholder="Drug detail">
                        </div>
                    ...
                    @foreach ($getRecord as $value)
                        <tr>
                            ...
                            <td style="min-width: 150px;">
                                ...
                                <a href="{{ route('medication_treatment.more_record.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                                <form action="{{ url('admin/disease_treatment/medication_treatment/More_record/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
