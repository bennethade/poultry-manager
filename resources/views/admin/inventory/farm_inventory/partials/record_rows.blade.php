    ...
    @foreach ($getRecord as $value)
        <tr>
            ...
            <td style="min-width: 250px;">
                <a href="{{ route('farm_inventory.more_record', [$value->id]) }}" class="btn btn-secondary btn-sm">More Record</a>

                <a href="{{ route('farm_inventory.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                <form action="{{ url('admin/inventory/farm_inventory/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                    @csrf
                    @method('DELETE')
