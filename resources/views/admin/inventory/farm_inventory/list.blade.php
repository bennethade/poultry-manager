    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6" style="text-align: right;">
          <a href="{{ route('farm_inventory.add') }}" class="btn btn-primary">Add New Record</a>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <a href="{{ route('farm_inventory.list') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
              </div>
            ...
            <div class="card-body p-0" style="overflow: auto;">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  @include('admin.inventory.farm_inventory.partials.record_rows')
    ...
    <script>
      ...
      $(document).ready(function () {
          $('input[name="name"]').on('keyup', debounce(function () {
              ...
              $.ajax({
                  url: "{{ route('farm_inventory.ajax.search') }}",
                  type: "GET",
                  data: { name: query },
