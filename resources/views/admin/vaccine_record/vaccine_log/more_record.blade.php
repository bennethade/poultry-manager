...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card">
        <form action="{{ route('vaccine_log.more_record.store', $getVaccineLog->id) }}" method="POST" class="breeding-form">
            @csrf
                ...
                <div id="breedFormBody" style="display:none;">
                    <div class="row">
                        ...
                        {{-- <div class="form-group col-md-4">
                            ...
                            <input class="form-control" type="number" name="quantity_used" placeholder="Today's usage (KG)">
                        </div> --}}
                    ...
                    @foreach ($getRecord as $value)
                        <tr>
                            ...
                            <td style="min-width: 150px;">
                                ...
                                <a href="{{ route('vaccine_log.more_record.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                                <form action="{{ url('admin/vaccine_record/vaccine_log/more_record/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
