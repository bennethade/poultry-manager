...
<section class="content-header">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('staff.vaccine_schedule.add') }}" class="btn btn-primary btn-sm">
    ...
    <div class="card-body p-0 table-responsive">
        <table class="table table-hover table-striped mb-0">
            ...
            <tbody id="incidenceTableBody">
                @include('staff.vaccine_record.vaccine_schedule.partials.table_rows', ['records' => $getRecord])
            </tbody>
        </table>
    </div>
</div>
...
$(document).ready(function () {
    ...
    $('#vaccineSearch').on('keyup', debounce(function () {
        ...
        $.ajax({
            url: "{{ route('staff.vaccine_schedule.ajax.search') }}",
            type: "GET",
            data: { query: query },
