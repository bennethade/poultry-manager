...
<section class="content-header d-flex justify-content-between">
    ...
    <a href="{{ route('staff.vaccine_log.add') }}" class="btn btn-primary btn-sm">
    ...
    <div class="card-body p-0 table-responsive">
        <table class="table table-striped table-hover mb-0">
            ...
            <tbody id="medicationTableBody">
                @include('staff.vaccine_record.vaccine_log.partials.table_rows',['records'=>$getRecord])
            </tbody>
        </table>
    </div>
</div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#medicationSearch').on('keyup', debounce(function () {
                $.get("{{ route('staff.vaccine_log.ajax.search') }}", {
                    query: $(this).val()
                }, function (data) {
