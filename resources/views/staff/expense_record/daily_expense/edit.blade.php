        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form method="POST" action="{{ route('staff.expenses.update', $getRecord->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-8">
                            <label>Category<span style="color: red">*</span> </label>
                            <input type="text" class="form-control" name="category" required placeholder="Eg: Feed, Utilities, Medicine, Fuel, etc." value="{{ old('category', $getRecord->category) }}">
                            <div style="color: red;">{{ $errors->first('category') }}</div>
                        </div>

                        <div class="form-group col-md-4">
                          <label>Amount <span style="color: red">*</span> </label>
                            <input type="number" class="form-control" name="amount" required placeholder="Eg: 500" value="{{ old('amount', $getRecord->amount) }}">
                            <div style="color: red;">{{ $errors->first('amount') }}</div>
                        </div>

                        <div class="form-group col-md-4">
                          <label>Payment Method</label>
                            <input type="text" class="form-control" name="payment_method" placeholder="Cash, Transfer, etc." value="{{ old('payment_method', $getRecord->payment_method) }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control" name="description" rows="3" placeholder="Add details of expense made" required>{{ old('description', $getRecord->description) }}</textarea>
