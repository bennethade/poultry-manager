        ...
        <tr>
            ...
            <td>
                @if (!empty($value->picture))
                    <a href="{{ asset('upload/expenses/' . $value->picture) }}" target="_blank">
                        <img 
                            src="{{ asset('upload/expenses/' . $value->picture) }}" 
                            alt="Picture" 
            ...
            <td style="min-width: 100px;">
                <a href="{{ route('staff.expenses.view', [$value->id]) }}" class="btn btn-warning btn-sm">View</a>
                
                {{-- <a href="{{ route('staff.expenses.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                <form action="{{ url('staff/expense_record/daily_expense/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                    @csrf
                    @method('DELETE')
