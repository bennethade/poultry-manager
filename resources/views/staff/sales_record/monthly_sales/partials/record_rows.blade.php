    ...
    @foreach ($getRecord as $value)
        <tr>
            ...
            {{-- <td style="min-width: 150px;">
                <a href="{{ route('staff.monthly_sales.edit', [$value->id]) }}" class="btn btn-primary btn-sm">Edit</a>

                <form action="{{ url('staff/sales_record/monthly_sales_summary/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                    @csrf
                    @method('DELETE')
