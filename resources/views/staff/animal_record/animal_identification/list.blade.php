    ...
    <div class="container-fluid">
      <div class="row mb-2">
        ...
        <div class="col-sm-6" style="text-align: right;">
          <a href="{{ route('staff.animal_identification.add') }}" class="btn btn-primary">Add New Animal</a>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <a href="{{ route('staff.animal_identification.list') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
              </div>
            ...
            <div class="card-body p-0" style="overflow: auto;">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  @include('staff.animal_record.animal_identification.partials.record_rows')
