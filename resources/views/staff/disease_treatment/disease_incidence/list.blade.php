...
<section class="content-header">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('staff.disease_incidence.add') }}" class="btn btn-primary btn-sm">
    ...
    <div class="card-body p-0 table-responsive">
        <table class="table table-hover table-striped mb-0">
            ...
            <tbody id="incidenceTableBody">
                @include('staff.disease_treatment.disease_incidence.partials.table_rows', ['records' => $getRecord])
            </tbody>
        </table>
    </div>
</div>
...
$(document).ready(function () {
    ...
    $('#incidenceSearch').on('keyup', debounce(function () {
        ...
        $.ajax({
            url: "{{ route('staff.disease_incidence.ajax.search') }}",
            type: "GET",
            data: { query: query },
