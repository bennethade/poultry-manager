...
@forelse($records as $record)
    <tr>
        ...
        {{-- <td style="min-width: 100px;">
            ...
            <a href="{{ route('staff.disease_incidence.edit', $record->id) }}" title="Edit" class="btn btn-warning btn-sm">
                <i class="fas fa-edit"></i>
            </a>

            <form action="{{ route('staff.disease_incidence.delete', $record->id) }}" method="POST" class="d-inline">
                @csrf
                @method('DELETE')
