          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-6">
              <div class="small-box bg-success">
                ...
                <a href="{{ route('staff.farm_record.list') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-6">
              <div class="small-box bg-info">
                ...
                <a href="{{ route('staff.farm_daily_care.list') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-6">
              <div class="small-box bg-danger">
                ...
                <a href="{{ route('staff.expenses.list') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-6">
              <div class="small-box" style="background: #996800; color:white">
                ...
                <a href="{{ route('staff.sales.list') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show">
                <strong>Your account is inactive! Please contact the admin for activation.</strong>
              </div>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
