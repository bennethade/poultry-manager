...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card">
        <form action="{{ route('staff.maintenance_sanitation.store') }}" method="POST">
            @csrf
                    ...
                    @foreach ($getRecord as $value)
                        <tr>
                            ...
                            {{-- <td style="min-width: 150px;">                                
                                ...
                                <form action="{{ url('staff/general_farm_activity/maintenance_sanitation/delete/'.$value->id) }}" method="POST" class="d-inline-block delete-form">
                                    @csrf
                                    @method('DELETE')
