        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form method="POST" action="{{ route('staff.feed_formulation.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" name="quantity" placeholder="Eg: 20" value="{{ old('quantity') }}" step="any">
                            <div style="color: red;">{{ $errors->first('quantity') }}</div>
                        </div>

                        <div class="form-group col-md-3">
                            <label>Total Output (KG)</label>
                            <input type="number" class="form-control" name="total_output" placeholder="Eg: 30" value="{{ old('total_output') }}" step="any">
                            <div style="color: red;">{{ $errors->first('total_output') }}</div>
                        </div>

                        <div class="form-group col-md-3">
                            <label>Cost</label>
                            <input type="number" class="form-control" name="cost" placeholder="2000" value="{{ old('cost') }}" step="any">
