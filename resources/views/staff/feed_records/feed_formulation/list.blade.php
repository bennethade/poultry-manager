...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Feed Formulation Record</h1>
        </div>
        <div class="col-sm-6" style="text-align: right;">
          <a href="{{ route('staff.feed_formulation.add') }}" class="btn btn-primary">Add New Record</a>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-3">
                ...
                <a href="{{ route('staff.feed_formulation.list') }}" class="btn btn-success" style="margin-top: 32px;">Refresh</a>
              </div>
            ...
            <div class="card-body p-0" style="overflow: auto;">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  @include('staff.feed_records.feed_formulation.partials.record_rows')
    ...
    <script>
      ...
      $(document).ready(function () {
          $('input[name="name"]').on('keyup', debounce(function () {
              ...
              $.ajax({
                  url: "{{ route('staff.feed_formulation.ajax.search') }}",
                  type: "GET",
                  data: { name: query },
