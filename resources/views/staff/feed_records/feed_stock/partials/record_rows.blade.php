        ...
        <tr>
            ...
            <td>
                @if (!empty($value->picture))
                    <a href="{{ asset('upload/feed_stock/' . $value->picture) }}" target="_blank">
                        <img 
                            src="{{ asset('upload/feed_stock/' . $value->picture) }}" 
                            alt="Picture" 
            ...
            <td style="min-width: 150px;">
                ...
                <a href="{{ route('staff.feed_stock.more_record', [$value->id]) }}" class="btn btn-secondary btn-sm">More Record</a>
