        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form method="POST" action="{{ route('staff.feed_stock.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control" name="cost_per_kg" placeholder="2000" value="{{ old('cost_per_kg') }}" step="any">
